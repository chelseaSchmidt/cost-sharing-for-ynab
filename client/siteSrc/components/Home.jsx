    ...
    <div>
      ...
      <div id="content-container" className="column">
        ...
        <ol className="description">
          <li>
            Open the web app by selecting the button below, or in the menu at the top right of the screen. You will be redirected to a YNAB authorization screen to enter your credentials.
          </li>
          <li>
            Optional: select one or more YNAB banking accounts that you use for shared costs, such as a shared credit card, if your situation is similar to the example above. If you don't use any one account specifically for shared costs, don't worry about this step.
          </li>
          <li>
          ...
          <li>
            Select all or some of the shared cost transactions, and hit the "Split Selected Transactions" button to create a  single summary transaction in your YNAB budget that moves half the amount from each affected budget category to the IOU account.
          </li>
        </ol>
        <a
